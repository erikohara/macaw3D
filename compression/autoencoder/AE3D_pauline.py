...
from .nets import Encoder3DPauline, Decoder3DPauline
...
class AE3D:
    def __init__(self, encoded_dim, dataloader, lr=0.01):
        ...
        o0 = _o(_o(_o(_o(_o(_o(_o(_o(_o(_o(d0, 0, 3, 1), 0, 3, 1), 1, 2, 2), 0, 3, 1), 0, 3, 1), 1, 2, 2), 0, 3, 1), 0, 3, 1), 1, 2, 2), 0, 3, 1)
        o1 = _o(_o(_o(_o(_o(_o(_o(_o(_o(_o(d1, 0, 3, 1), 0, 3, 1), 1, 2, 2), 0, 3, 1), 0, 3, 1), 1, 2, 2), 0, 3, 1), 0, 3, 1), 1, 2, 2), 0, 3, 1)
        o2 = _o(_o(_o(_o(_o(_o(_o(_o(_o(_o(d2, 0, 3, 1), 0, 3, 1), 1, 2, 2), 0, 3, 1), 0, 3, 1), 1, 2, 2), 0, 3, 1), 0, 3, 1), 1, 2, 2), 0, 3, 1)

        print(f"Show sizes after conv: {o0}, {o1}, {o2}")

        self.encoder = Encoder3DPauline(self.encoded_dim, o0, o1, o2)
        self.decoder = Decoder3DPauline(self.encoded_dim, o0, o1, o2)
