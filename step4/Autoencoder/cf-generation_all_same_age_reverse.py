...
output_image = f'/work/forkert_lab/erik/MACAW/cf_images/macaw_AE3D_6000_{cf_age_definition}_reverse'
...
data = np.load(reshaped_path + f'/reshaped_3D_102_150_150_macaw_AE3D_6000_{cf_age_definition}.npy')
