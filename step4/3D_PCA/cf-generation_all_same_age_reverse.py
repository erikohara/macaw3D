...
#output_image = f'/work/forkert_lab/erik/MACAW/cf_images/PCA3D_15000_new_{cf_age_definition}_reverse'
output_image = f'/scratch/{job_id}/PCA3D_15000_full_{cf_age_definition}_reverse'
...
data = np.load(reshaped_path + f'/reshaped_3D_PCA3D_15000_full_{cf_age_definition}.npy')
