...
output_image = f'/work/forkert_lab/erik/MACAW/cf_images/macaw_vqvae8_50_nevecs_{cf_age_definition}_reverse'
...
data = np.load(reshaped_path + f'/reshaped_3D_102_150_150_macaw_vqvae8_50_nevecs_{cf_age_definition}.npy')
    ...
    try:
        ...
        with torch.no_grad():
            ...
            if (len(cc_nan_places) > 0):
                print(f"nan values produced on cc evec {ev}:")
                print(cc_nan_places)
                cc = np.nan_to_num(cc)
