...
output_image = f'/work/forkert_lab/erik/MACAW/cf_images/2_5Z_{cf_age_definition}'
...
for individual in range(nsamples):
    ...
    nib.save(ni_img, output_image + "/" + str(random_eids[individual])  + f"_{int(age_cf)}_{sex_cf[individual]}_{slice_initial}-{slice_final-1}.nii.gz")
