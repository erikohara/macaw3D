...
# Getting site counterfectual age
...
output_image = "/work/forkert_lab/erik/MACAW/cf_images/PCA_sklearn_{}".format(cf_age_definition)
...
number_files = count_files_folder(output_image)

print(f"Number of unique ID files is: {number_files}")