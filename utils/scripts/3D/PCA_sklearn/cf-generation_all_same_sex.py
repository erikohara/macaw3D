...
output_image = f'/work/forkert_lab/erik/MACAW/cf_images/2_5Z_sex_{cf_sex}'
...
for individual in range(nsamples):
    ...
    nib.save(ni_img, output_image + "/" + str(random_eids[individual])  + f"_{int(age_cf[individual])}_{sex_cf}_{slice_initial}-{slice_final-1}.nii.gz")
