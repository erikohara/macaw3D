...
model_path = f"/work/forkert_lab/erik/MACAW/models/macaw_AE3D_{ncomps}"
reshaped_path = '/work/forkert_lab/erik/MACAW/reshaped/3D'
output_image = f'/work/forkert_lab/erik/MACAW/cf_images/macaw_AE3D_{ncomps}_zero_diff_2'
cf_age_path = '/work/forkert_lab/erik/MACAW/2_5'
original_images = "/work/forkert_lab/erik/T1_warped"
ae_path = f'/work/forkert_lab/erik/MACAW/models/AE3D_{ncomps}_previous'
number_images = 2370
batch_size_ae = 2
