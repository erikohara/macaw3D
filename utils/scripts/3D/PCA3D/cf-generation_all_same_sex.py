...
#output_image = '/work/forkert_lab/erik/MACAW/cf_images/PCA3D_15000_new_sex_females'
output_image = f'/scratch/{job_id}/PCA3D_15000_full_sex_females'
...
for individual in range(nsamples):
    ...
    nib.save(ni_img, output_image + "/" + str(random_eids[individual])  + f"_{int(age_cf[individual])}_{int(sex_cf)}_{slice_initial}-{slice_final-1}.nii.gz")
