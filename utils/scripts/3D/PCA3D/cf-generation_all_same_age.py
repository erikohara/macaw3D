...
#output_image = f'/work/forkert_lab/erik/MACAW/cf_images/PCA3D_15000_full_{cf_age_definition}'
output_image = f'/scratch/{job_id}/PCA3D_15000_full_{cf_age_definition}'
