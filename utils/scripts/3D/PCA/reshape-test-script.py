...
batch_size = 32
rs = 150
ukbb_path_T1_slices = '/work/forkert_lab/erik/T1_cropped_slices/T1_cropped_slice_{}/test'.format(z_slice)
output_path = '/work/forkert_lab/erik/MACAW/reshaped/PCA/test'
...
with open(output_path + '/reshaped_test_slice_{}.npy'.format(z_slice), 'wb') as f:
    np.save(f, data)
