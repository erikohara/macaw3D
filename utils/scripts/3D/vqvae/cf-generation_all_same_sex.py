...
output_image = f'/work/forkert_lab/erik/MACAW/cf_images/macaw_vqvae8_50_nevecs_sex_{cf_sex}_reverse'
...
for individual in range(nsamples):
    ...
    nib.save(ni_img, output_image + "/" + str(random_eids[individual])  + f"_{int(age_cf[individual])}_{sex_cf}.nii.gz")
