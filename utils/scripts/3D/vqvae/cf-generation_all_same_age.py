...
output_image = f'/work/forkert_lab/erik/MACAW/cf_images/macaw_vqvae8_50_nevecs_{cf_age_definition}'
...
for individual in range(nsamples):
    ...
    nib.save(ni_img, output_image + "/" + str(random_eids[individual])  + f"_{int(age_cf)}_{sex_cf[individual]}.nii.gz")
