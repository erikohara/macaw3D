...
model_path = f"/work/forkert_lab/erik/MACAW/models/macaw_vqvae8_50nevecs_nan_to_num_scaler"
...
output_image = '/work/forkert_lab/erik/MACAW/cf_images/macaw_vqvae8_50nevecs_nan_to_num_scaler'
