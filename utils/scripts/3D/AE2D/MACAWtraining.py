...
output_path = f"/work/forkert_lab/erik/MACAW/models/macaw_AE2D_{ncomps}/slice_{z_slice}"
ae_path = f'/work/forkert_lab/erik/MACAW/models/AE2D_{ncomps}/slice_{z_slice}'
